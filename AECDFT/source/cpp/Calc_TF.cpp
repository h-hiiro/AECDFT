...
bool calc_TFPotential(int N, double *X, double *VTF, double InitialDiff_left,
                      double InitialDiff_right, double Threshold) {
...
void calc_TFDensity(int N, double *R, double *VTF, double Z, double *V,
                    double *rho) {
  int i;
  ...
  printf("[C.calc_TFDensity] Rho_total %.3f / Z %.3f\n", rho_total, Z);
}